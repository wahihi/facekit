...
자세한 설계는 [doc/EN/architecture.md](doc/EN/architecture.md) /
[doc/KR/architecture.md](doc/KR/architecture.md)에 있습니다.
...
방법론·VM 비교·정확도(EER) 표 등 전체 내용은 [doc/KR/benchmark.md](doc/KR/benchmark.md) 참고.
...
AdaFace가 더 강건합니다(자세한 수치는 [doc/KR/adaface_verification.md](doc/KR/adaface_verification.md)).
...
포함되어 있지 않습니다.** 자세한 한계는 [doc/KR/liveness.md](doc/KR/liveness.md) 참고.
